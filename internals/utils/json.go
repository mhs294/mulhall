...
// ParseRequestJSON reads the JSON body of an HTTP request and deserializes its contents into the object
...
func ParseRequestJSON(v interface{}, ctx *gin.Context) error {
